    ...
    <div style={{
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        <div style={{
          ...
          justifyContent: "center", gap: "24px", marginBottom: "6px"
        }}>
          <div style={{ textAlign: "right" }}>
            <div style={{ fontSize: "14px", color: "#64748b", marginBottom: "2px" }}>{game.awayTeam}</div>
            <div style={{ fontSize: "42px", fontWeight: 700, color: "#ff6b6b", lineHeight: 1 }}>{game.scoreAway}</div>
          </div>
          <div style={{ color: "#2d3748", fontSize: "24px", fontWeight: 300 }}>@</div>
          <div style={{ textAlign: "left" }}>
            <div style={{ fontSize: "14px", color: "#64748b", marginBottom: "2px" }}>{game.homeTeam}</div>
            <div style={{ fontSize: "42px", fontWeight: 700, color: "#00d4aa", lineHeight: 1 }}>{game.scoreHome}</div>
          </div>
        </div>
        <div style={{
      ...
      <div style={{ marginBottom: "6px" }}>
        <div style={{
          ...
          <div style={{
            ...
            display: "flex", alignItems: "center",
            justifyContent: "center",
            fontSize: "13px", fontWeight: 600, color: "#00d4aa",
            transition: "width 0.5s ease"
          }}>
            {homePct}%
          </div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", marginTop: "4px", fontSize: "12px" }}>
          <span style={{ color: "#ff6b6b" }}>{game.awayTeam} win probability</span>
          <span style={{ color: "#00d4aa" }}>{game.homeTeam} win probability</span>
        </div>
      </div>
      ...
      {game.players && (
        <div style={{ marginTop: "20px", borderTop: "1px solid #1e1e2e", paddingTop: "20px" }}>
          <div style={{ fontSize: "12px", color: "#4a5568", marginBottom: "12px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em" }}>
            Player Stats
          </div>
